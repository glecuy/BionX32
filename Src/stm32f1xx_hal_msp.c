...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA4     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = M1_CURR_AMPL_Pin|M1_BUS_VOLTAGE_Pin|M1_TEMPERATURE_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOA, M1_CURR_AMPL_Pin|M1_BUS_VOLTAGE_Pin|M1_TEMPERATURE_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = DAC_EMUL_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(DAC_EMUL_CH2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M1_HALL_H1_Pin|M1_HALL_H2_Pin);

    HAL_GPIO_DeInit(M1_HALL_H3_GPIO_Port, M1_HALL_H3_Pin);
