...
__weak void DACT_Exec(UI_Handle_t *pHandle)
{
  ...
  LL_TIM_OC_SetCompareCH1(TIM2, ((uint16_t)((int16_t)(((int16_t)UI_GetReg(pHandle,bCh1_var,MC_NULL)+32768)/32))));
  LL_TIM_OC_SetCompareCH2(TIM2, ((uint16_t)((int16_t)(((int16_t)UI_GetReg(pHandle,bCh2_var,MC_NULL)+32768)/32))));
}
